...
<script>
    //
    //CANCION
    var cancion = "EDEN - Pocket (montreal)";
    //
    //WALLPAPER
    var titulo = "Oficial";
    var texto = "Aquí";
    var wfuente = "https://youtu.be/qLadMVwu1_w?si=mqEexwBHz4tbLs_N";
    //
    //PISTAS
    var vocals = "";
    var instrumental = "";
    ...
    var videoLink = "https://web.archive.org/web/20240801235542/https://files.catbox.moe/sokxj4.mov";
    //
    //
    //
    //ARTISTA 1
...
<body>
    <table>
        ...
        <tr><td colspan="2">‎‎</td><td colspan="2"></td></tr><tr><td colspan="2">the zipper brokethe zipper broke</td><td colspan="2">El zíper se rompió</td></tr><tr><td colspan="2">now I cant open up my pocketnow I cant open up my pocket</td><td colspan="2">Y ahora no puedo abrir mi bolsillo</td></tr><tr><td colspan="2">your guard is upyour guard is up</td><td colspan="2">Estabas a la defensiva</td></tr><tr><td colspan="2">so we just shadow boxingso we just shadow boxing</td><td colspan="2">Así que terminamos boxeando contra la nada</td></tr><tr><td colspan="2">they called it lost</td><td colspan="2">Dan esto por perdido</td></tr><tr><td colspan="2">but I still feel it in there somewhere</td><td colspan="2">Pero aún puedo sentirlo en alguna parte</td></tr><tr><td colspan="2">but my hands are cold</td><td colspan="2">Aun así, mis manos sienten frío</td></tr><tr><td colspan="2">you said “then get out the snow,</td><td colspan="2">Me dijiste "entonces aléjate de la nieve,-</td></tr><tr><td colspan="2">its not difficult”</td><td colspan="2">-no es tan difícil"</td></tr><tr><td colspan="2">she said do I believe in angels?</td><td colspan="2">Ella me preguntó si es que creo en los ángeles</td></tr><tr><td colspan="2">(cant call it right now)</td><td colspan="2">(No puedo responderte eso ahora mismo)</td></tr><tr><td colspan="2">“cant rely on what I cant see” (too far to turn back)“cant rely on what I cant see” (too far to turn back)</td><td colspan="2">"No puedo confiar en lo que no puedo ver" (fuimos demasiado lejos para dar marcha atrás)</td></tr><tr><td colspan="2">(cant see the night out)(cant see the night out)</td><td colspan="2">(no puedo soportar despierto toda la noche)</td></tr><tr><td colspan="2">“so why cant you tell me something (in this car there’s no fighting)“so why cant you tell me something (in this car there’s no fighting)</td><td colspan="2">"Entonces, ¿por qué no puedes decirme algo- (en este auto no habrá peleas)</td></tr><tr><td colspan="2">(and no cares for missed timing)(and no cares for missed timing)</td><td colspan="2">(y no importa el tiempo perdido)</td></tr><tr><td colspan="2">that doesn’t feel like your lying,,?” (these no blood just psilocybin)that doesn’t feel like your lying,,?” (these no blood just psilocybin)</td><td colspan="2">-que no se sienta como si me estuvieras mintiendo?" (no hay violencia, solo psilocibina)</td></tr><tr><td colspan="2">(we peace signing)</td><td colspan="2">(ambos haciendo señales de paz)</td></tr><tr><td colspan="2">but my zipper broke</td><td colspan="2">Pero mi zíper se rompió</td></tr><tr><td colspan="2">and I cant open up my pocket</td><td colspan="2">Y ahora no puedo abrir mi bolsillo</td></tr><tr><td colspan="2">I cant open up, I know</td><td colspan="2">No puedo abrir(me), lo sé</td></tr><tr><td colspan="2">its all</td><td colspan="2">Es todo</td></tr><tr><td colspan="2">snow,</td><td colspan="2">Nieve</td></tr><tr><td colspan="2">snow,</td><td colspan="2">Nieve</td></tr><tr><td colspan="2">that’s all</td><td colspan="2">Eso es todo.</td></tr><tr><td colspan="2">‎‎</td><td colspan="2"></td></tr>
