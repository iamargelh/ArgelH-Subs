...
<script>
    //
    //CANCION
    var cancion = "Tristam - 1992";
    //
    //WALLPAPER
    var titulo = "Oficial";
    var texto = "Aquí";
    var wfuente = "https://www.youtube.com/watch?v=pqbiHOc3Awk";
    //
    //PISTAS
    var vocals = "";
    var instrumental = "";
...
<body>
    <table>
        ...
        <tr>
            ...
            <td class="top-align align-left"><img src="https://i.imgur.com/RQLfOkU.gif" width="80ch"><br><img src="https://i.imgur.com/Zl365Py.png" width="80ch" style="box-shadow: inset 0 0 0 1000px rgb(0, 0, 0);"></td>
        </tr>
    </table>
