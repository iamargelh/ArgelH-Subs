...
<script>
    //
    //CANCION
    var cancion = "Tristam - Burn";
    //
    //WALLPAPER
    var titulo = "Collage hecho por mí";
    var texto = "Aquí";
    var wfuente = "https://files.catbox.moe/i5dhog.mp4";
    //
    //PISTAS
    var vocals = "";
    var instrumental = "";
...
<body>
    <table>
        ...
        <tr>
            ...
            <td class="top-align align-left"><img src="https://i.imgur.com/RQLfOkU.gif" width="80ch"><br><img src="https://i.imgur.com/Lj3BZR9.png" width="80ch" style="box-shadow: inset 0 0 0 1000px rgb(0, 0, 0);"></td>
        </tr>
    </table>
